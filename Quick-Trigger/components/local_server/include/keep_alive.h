#ifndef COMPONENTS_LOCAL_SERVER_INCLUDE_KEEP_ALIVE_H_
#define COMPONENTS_LOCAL_SERVER_INCLUDE_KEEP_ALIVE_H_
...
#endif /* COMPONENTS_LOCAL_SERVER_INCLUDE_KEEP_ALIVE_H_ */
